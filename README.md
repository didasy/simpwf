...
| POST       | `/v1/workflow/instance/{id}/rollback`              | roll back a paused/failed instance to a prior node occurrence (always lands paused, restores `context_before`; live parked input attempt superseded, self-target is a no-op) |
